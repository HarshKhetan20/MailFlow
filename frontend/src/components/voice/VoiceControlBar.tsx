  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        {/* Center: Large Interactive Microphone Button */}
          ...
          <div style={{ position: 'relative', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            ...
            >
              {isProcessing ? (
                ...
                <MicOff size={28} color="rgba(255,255,255,0.7)" />
              )}
            </button>
          </div>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', minWidth: '280px', justifyContent: 'flex-end' }}>
          ...
          <button
            ...
            style={{
              ...
              borderRadius: 'var(--radius-md)',
              border: 'none',
              background: canSend && isConfirmReady
